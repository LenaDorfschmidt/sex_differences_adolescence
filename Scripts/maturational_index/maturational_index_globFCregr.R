...
fc.m <- rowMeans(str)
nroi=346
MRI_table$glob.fc = fc.m

# Global
fc.glob=cbind(MRI_table,rowMeans(str))
colnames(fc.glob)[ncol(fc.glob)] = 'FC'
glob.m = lme(FC~mri_pseudo_age+sex+mri_center, random=~1|id_nspn,data=fc.glob)
...
# Calc group glob FC
glob.FC.m = glob.m$coefficients$fixed[1] + 14*glob.m$coefficients$fixed[2] + glob.m$coefficients$fixed[3] + glob.m$coefficients$fixed[4]*(1/3) + + glob.m$coefficients$fixed[5]*(1/3)
glob.FC.f = glob.m$coefficients$fixed[1] + 14*glob.m$coefficients$fixed[2] + glob.m$coefficients$fixed[4]*(1/3) + glob.m$coefficients$fixed[5]*(1/3)
group.glob.FC = list(glob.FC.f, glob.FC.m)
...
for (s in (1:2)) {
  ...
  for (n in 1:nroi) {
    # str
    try({
      df = data.frame(x1 = MRI_table$mri_pseudo_age[gender_idx], x2 = MRI_table$mri_center[gender_idx], x3 = MRI_table$glob.fc[gender_idx], y = str[gender_idx,n], id = MRI_table$id_nspn[gender_idx]) # data frame for lme
      ...
      str.l.14[s,n] = l$coefficients$fixed[1] + l$coefficients$fixed[2]*14 + l$coefficients$fixed[3]*(1/3) + l$coefficients$fixed[4]*(1/3) +  group.glob.FC[[s]] * l$coefficients$fixed[5] 
    })

    try({
      df = data.frame(x1 = MRI_table$mri_pseudo_age[gender_idx], x2 = MRI_table$mri_center[gender_idx], x3 = MRI_table$glob.fc[gender_idx], y = str.cort[gender_idx,n], id = MRI_table$id_nspn[gender_idx])
      l = lme(y ~ x1 + x2 + x3, random = ~ 1|id, data = df)
      str.cort.l.sl.p[s,n] = summary(l)$tTable[2,5]
      str.cort.l.sl.t[s,n] = summary(l)$tTable[2,4]
      str.cort.l.14[s,n] = l$coefficients$fixed[1] + l$coefficients$fixed[2]*14 + l$coefficients$fixed[3]*(1/3) + l$coefficients$fixed[4]*(1/3) +  group.glob.FC[[s]] * l$coefficients$fixed[5] 
      str.cort.l.sl[s,n] = l$coefficients$fixed[2]
    })

    try({
      df = data.frame(x1 = MRI_table$mri_pseudo_age[gender_idx], x2 = MRI_table$mri_center[gender_idx],  x3 = MRI_table$glob.fc[gender_idx], y = str.subc[gender_idx,n], id = MRI_table$id_nspn[gender_idx])
      l = lme(y ~ x1 + x2 + x3, random = ~ 1|id, data = df)
      str.subc.l.sl.p[s,n] = summary(l)$tTable[2,5]
      str.subc.l.sl.t[s,n] = summary(l)$tTable[2,4]
      str.subc.l.14[s,n] = l$coefficients$fixed[1] + l$coefficients$fixed[2]*14 + l$coefficients$fixed[3]*(1/3) + l$coefficients$fixed[4]*(1/3) +  group.glob.FC[[s]] * l$coefficients$fixed[5] 
  ...
  for (i in 1:nsub) {
    for (n in 1:nroi) {
      try({
        df = data.frame(x1 = MRI_table$mri_pseudo_age[gender_idx], x2 = MRI_table$mri_center[gender_idx], x3 = MRI_table$glob.fc[gender_idx], y = str.subc.cort[[i]][n,gender_idx], id = MRI_table$id_nspn[gender_idx])
        l = lme(y ~ x1 + x2 + x3, random = ~ 1|id, data = df)
        str.subc.cort.l.sl.p[s,i,n] = summary(l)$tTable[2,5]
        str.subc.cort.l.sl.t[s,i,n] = summary(l)$tTable[2,4]
        str.subc.cort.l.14[s,i,n] = l$coefficients$fixed[1] + l$coefficients$fixed[2]*14 + l$coefficients$fixed[3]*(1/3) + l$coefficients$fixed[4]*(1/3) +  group.glob.FC[[s]] * l$coefficients$fixed[5] 
  ...
  df.aseg$value = str.l.sl[1,aseg.nm.idx]
  ...
  for (i in 1:(nroi-1)) { # only loop over upper triangular (as matrices are symmetric), and then fill lower triangular with the transpose
    ...
    for (j in (i+1):nroi) {
      possibleError <- tryCatch({
        df = data.frame(x1 = MRI_table$mri_pseudo_age[gender_idx], x2 = MRI_table$mri_center[gender_idx], x3 = MRI_table$glob.fc[gender_idx], y = fc[i,j,gender_idx], id = MRI_table$id_nspn[gender_idx])  # data frame for model fitting
        ...
        fc.l.14[i,j] = l$coefficients$fixed[1] + l$coefficients$fixed[2]*14 + l$coefficients$fixed[3]*(1/3) + l$coefficients$fixed[4]*(1/3) +  group.glob.FC[[s]] * l$coefficients$fixed[5]
