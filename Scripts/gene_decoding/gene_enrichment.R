...
genes <- getBM(attributes=c('hgnc_symbol','ensembl_gene_id','chromosome_name','start_position','end_position'), 
               filters = 'hgnc_symbol', values = pls1_lena$gene_name, mart = mart, uniqueRows = T)
...
for (chr in levels(as.factor(genes$chromosome_name))[-c(23:105)]) {
  try({
...
pdf('~/Documents/Education/Cambridge/fMRI_NSPN/Results/gene_decoding/chromosome.enrichment.pdf',height=5,width=4)
...
pdf('~/Documents/Education/Cambridge/fMRI_NSPN/Results/gene_decoding/chromosomal.enrichment.null.pdf',height=5,width=4)
...
pdf('~/Documents/Education/Cambridge/fMRI_NSPN/Results/gene_decoding/postnatal.celltype.enrichment.pdf',height=3,width=4)
...
pdf('~/Documents/Education/Cambridge/fMRI_NSPN/Results/gene_decoding/prenatal.celltype.enrichment.pdf',height=5,width=4)
  print(p)
dev.off()
...
pdf('~/Documents/Education/Cambridge/fMRI_NSPN/Results/gene_decoding/howard.enrichment.pdf',height=1.75,width=4)
ggplot(howard_plot) +
