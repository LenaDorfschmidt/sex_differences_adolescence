...
sample = 'regr_FD_by_sex'; %sample = 'CV_stratified';
...
elseif strcmp(sample,'CV_stratified')
    path_data= ['../../Results/replication/' sample '/gene_decoding/plsout/'];
    inpath = ['../../Results/replication/' sample '/maturational_index/'];
elseif strcmp(sample,'glob.fc.regr')
    path_data= ['../../Results/replication/' sample '/gene_decoding/plsout/'];
    inpath = ['../../Results/replication/' sample '/maturational_index/'];
elseif strcmp(sample,'GSR')
    path_data = '../../Results/replication/nspn.gsr/gene_decoding/plsout/';
    inpath = '../../Results/replication/nspn.gsr/maturational_index/';
elseif strcmp(sample,'motionmatched')
    path_data = '../../Results/replication/motionmatched/gene_decoding/plsout/';
    inpath = '../../Results/replication/motionmatched/maturational_index/';
elseif strcmp(sample,'regr_FD_by_sex')
    path_data = '../../Results/replication/regr_FD_by_sex/gene_decoding/plsout/';
...
for id=1:dim
    ...
    tab_all = table(PLSid',categorical(entrezID)',geneindex_ind',Z1',z_fdr');
    tab_all.Properties.VariableNames = {'gene_name','entrez_ID','gene_index','z_uncorr','z_fdr'};
...
writetable(array2table([PLS.XS(:,1), keep_idx]), [path_data 'pls_x.csv'],'WriteVariableNames',0,'WriteRowNames',0)
